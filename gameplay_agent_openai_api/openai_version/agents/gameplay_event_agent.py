...
class GameplayEventAgent(BaseAgent):
    def __init__(self, openai_api_key=None, model="gpt-4o-2024-08-06", scraper=None, extractor=None, mda_fallback=None):
        self.scraper = scraper or NeoSeekerScraper()
        self.extractor = extractor or GameplayEventExtractor(api_key=openai_api_key, model=model)
